...
//
//
//      System.out.println(i + " " + outputStream + " Prev element = " + prevElement + " ONES COUNTER = " + onesCounter);
//
//
//      if (stream.substring(i, i + 1).equals("1")) {
//        if(onesCounter == 5 && prevElement.equals("0") && zerosCounter == 1){
//          outputStream.delete(outputStream.length()-1,outputStream.length());
//          zerosCounter = 0;
//          onesCounter = 0;
//        }
